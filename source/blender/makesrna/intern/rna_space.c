...
static void rna_def_space_physarum(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_text(prop, "Particles population factor", "Number of particles used for the simulation");
  ...
  RNA_def_property_ui_text(prop, "Sensor angle", "");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_PHYSARUM, NULL);
